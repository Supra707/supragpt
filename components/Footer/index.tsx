...
const Footer = () => {
  return (
    <>
      <footer className="relative mt-10 border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                <div className="neon-glow ml-2 text-4xl font-extrabold tracking-tight text-black dark:text-white">
              SupraGpt
            </div>

                <p className="mb-10 mt-5">
                 A 20.10.2002 generated and envisoned ISO standardized and Cpability Maturity Model Certified Company 🤣
                </p>
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} SupraGpt. All rights reserved
              </p>
            </motion.div>
