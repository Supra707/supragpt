      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `Remotely Store Your Data, From Anywhere, Anytime.`,
              description: `
              Effortlessly oversee your data from anywhere with our solutions. Enjoy seamless access and control, enabling you to manage information securely at any time, from any location. Experience the convenience of remote data maintenance with confidence.`,
            }}
          />
